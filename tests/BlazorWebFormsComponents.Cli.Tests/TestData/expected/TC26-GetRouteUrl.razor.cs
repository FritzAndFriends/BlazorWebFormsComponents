...
namespace MyApp
{
    public partial class TC26_GetRouteUrl : WebFormsPageBase
    {
    ...
    // Ensure app.UseConfigurationManagerShim() is called in Program.cs.
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            var url = GetRouteUrl( /* TODO(bwfc-route-url): converted from Page route lookup – ensure page inherits WebFormsPageBase */ "ProductRoute", new { id = 42 });
