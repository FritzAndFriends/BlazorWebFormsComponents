...
public static class ComponentCatalog
{
    public static IReadOnlyList<ComponentInfo> Components { get; } = new List<ComponentInfo>
    {
        ...
        new("ClientScript", "Migration Helpers", "/ControlSamples/ClientScript", "ClientScript → IJSRuntime migration patterns: startup scripts, includes, focus, events",
            Keywords: new[] { "clientscript", "javascript", "ijsruntime", "startup", "postback", "migration" }),
        new("ClientScriptShim", "Migration Helpers", "/ControlSamples/ClientScriptShim", "Zero-rewrite migration: keep RegisterStartupScript/RegisterClientScriptInclude calls unchanged",
            Keywords: new[] { "clientscript", "shim", "registerstartupscript", "registerscriptinclude", "zero-rewrite", "migration" }),
