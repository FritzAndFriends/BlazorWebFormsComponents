// TODO(bwfc-action-pages): AddToCart now renders a visible SSR handler stub. Preserve the side effect, then redirect to /ShoppingCart.
// =============================================================================
...
namespace WingtipToys
{
  public partial class AddToCart : WebFormsPageBase
  {
    ...
    [Parameter, SupplyParameterFromQuery(Name = "ProductID")] public string? ProductID { get; set; }

    private const string HandlerRoute = "/__bwfc/actions/AddToCart";
    private const string RedirectTarget = "/ShoppingCart";
}
}