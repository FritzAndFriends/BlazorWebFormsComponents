...
var connectionString = "Data Source=wingtiptoys.db";
...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!productDb.Categories.Any())
    {
        productDb.Categories.AddRange(
            new Category { CategoryID = 1, CategoryName = "Cars", Description = "Cars" },
            new Category { CategoryID = 2, CategoryName = "Planes", Description = "Planes" },
            new Category { CategoryID = 3, CategoryName = "Trucks", Description = "Trucks" },
            new Category { CategoryID = 4, CategoryName = "Boats", Description = "Boats" },
            new Category { CategoryID = 5, CategoryName = "Rockets", Description = "Rockets" });
