...
namespace WingtipToys.Checkout
{
  public partial class CheckoutReview
  {
    ...
    private GridView<CartItem> OrderItemList = default!;
    private Label PostalCode = default!;
    private DetailsView<Order> ShipInfo = default!;
    ...
    protected override async Task OnInitializedAsync()
    {
      ...
      NVPAPICaller payPalCaller = new NVPAPICaller();
          ...
          if (ret)
          {
            ...
            myOrder.Username = Context?.User?.Identity?.Name ?? string.Empty;
            ...
            using (WingtipToys.Logic.ShoppingCartActions usersShoppingCart = new WingtipToys.Logic.ShoppingCartActions())
            {
              ...
              for (int i = 0; i < myOrderList.Count; i++)
              {
                ...
                myOrderDetail.Username = Context?.User?.Identity?.Name ?? string.Empty;
