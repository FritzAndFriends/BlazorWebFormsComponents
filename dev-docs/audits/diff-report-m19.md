...
Generated: 2026-03-01T19:00:31.861Z

## Summary
- Controls compared: 128
- Exact matches: 1
- Divergences found: 127
...
#### CheckBox-1 Diff
```diff
- <input id="chkTerms" type="checkbox" /><label for="MainContent_chkTerms">Accept Terms</label>
...
#### CheckBox-2 Diff
```diff
- <input checked id="chkSubscribe" type="checkbox" /><label for="MainContent_chkSubscribe">Subscribe</label>
...
#### CheckBox-3 Diff
```diff
- <input id="chkFeature" type="checkbox" /><label for="MainContent_chkFeature">Enable Feature</label>
...
- <tbody><tr>
- <td><input id="CheckBoxList1_0" type="checkbox" value="Reading" /><label for="MainContent_CheckBoxList1_0">Reading</label></td>
- </tr><tr>
- <td><input id="CheckBoxList1_1" type="checkbox" value="Sports" /><label for="MainContent_CheckBoxList1_1">Sports</label></td>
- </tr><tr>
- <td><input checked id="CheckBoxList1_2" type="checkbox" value="Music" /><label for="MainContent_CheckBoxList1_2">Music</label></td>
- </tr><tr>
- <td><input id="CheckBoxList1_3" type="checkbox" value="Travel" /><label for="MainContent_CheckBoxList1_3">Travel</label></td>
- </tr>
- </tbody></table>
```
...
- <tbody><tr>
- <td><input id="CheckBoxList2_0" type="checkbox" value="Small" /><label for="MainContent_CheckBoxList2_0">Small</label></td><td><input id="CheckBoxList2_1" type="checkbox" value="Medium" /><label for="MainContent_CheckBoxList2_1">Medium</label></td>
- </tr><tr>
- <td><input id="CheckBoxList2_2" type="checkbox" value="Large" /><label for="MainContent_CheckBoxList2_2">Large</label></td><td><input id="CheckBoxList2_3" type="checkbox" value="XLarge" /><label for="MainContent_CheckBoxList2_3">XLarge</label></td>
- </tr>
- </tbody></table>
```
...
#### DropDownList-4 Diff
```diff
- <select class="aspNetDisabled" disabled id="ddlDisabled">
...
- <option selected value="1">Cannot change</option>
- </select>
```
...
+ <input f16-8aa4-bed3eff8548b="" type="file" />
...
```diff
- <div>
+ <table class="table table-striped" style="border-collapse:collapse;"><thead><tr><th>ID</th><th>CompanyName</th><th>FirstName</th><th>LastName</th><th>&amp;nbsp;</th><th>&amp;nbsp;</th></tr></thead><tbody><tr><td>1</td><td>Virus</td><td>John</td><td>Smith</td><td><button type="button">Click Me! John</button></td><td><input type="submit" /></td></tr><tr><td>2</td><td>Boring</td><td>Jose</td><td>Rodriguez</td><td><button type="button">Click Me! Jose</button></td><td><input type="submit" /></td></tr><tr><td>3</td><td>Fun Machines</td><td>Jason</td><td>Ramirez</td><td><button type="button">Click Me! Jason</button></td><td><input type="submit" /></td></tr></tbody></table>
...
#### HiddenField Diff
```diff
- <input id="HiddenField1" type="hidden" value="secret-value-123" />
+ <input id="myHiddenField" type="hidden" value="initial-secret-value" />
```
...
#### ImageButton-1 Diff
```diff
- <input alt="Submit" id="ImageButton1" src="../../Content/Images/banner.png" type="image" />
+ <input alt="Submit" longdesc="" src="/img/placeholder-150x100.svg" type="image" />
```

#### ImageButton-2 Diff
```diff
- <input alt="Click here" class="img-button" id="ImageButton2" src="../../Content/Images/banner.png" type="image" />
+ <input alt="Styled submit button" class="img-button-styled" longdesc="" src="/img/placeholder-80x80.svg" title="Click this image button to submit" type="image" />
```
...
#### ListBox-2 Diff
```diff
- <select id="ListBox2" multiple size="4">
...
+ <table><tr><td><input id="f76154fab1ed40358b56d2e460eb4f8e_0" name="f76154fab1ed40358b56d2e460eb4f8e" type="radio" value="red" />
- <tbody><tr>
+ <label for="f76154fab1ed40358b56d2e460eb4f8e_0">Red</label></td></tr><tr><td><input id="f76154fab1ed40358b56d2e460eb4f8e_1" name="f76154fab1ed40358b56d2e460eb4f8e" type="radio" value="green" />
- <td><input id="RadioButtonList1_0" type="radio" value="Excellent" /><label for="MainContent_RadioButtonList1_0">Excellent</label></td>
+ <label for="f76154fab1ed40358b56d2e460eb4f8e_1">Green</label></td></tr><tr><td><input id="f76154fab1ed40358b56d2e460eb4f8e_2" name="f76154fab1ed40358b56d2e460eb4f8e" type="radio" value="blue" />
- </tr><tr>
+ <label for="f76154fab1ed40358b56d2e460eb4f8e_2">Blue</label></td></tr></table>
- <td><input checked id="RadioButtonList1_1" type="radio" value="Good" /><label for="MainContent_RadioButtonList1_1">Good</label></td>
- </tr><tr>
- <td><input id="RadioButtonList1_2" type="radio" value="Average" /><label for="MainContent_RadioButtonList1_2">Average</label></td>
- </tr><tr>
- <td><input id="RadioButtonList1_3" type="radio" value="Poor" /><label for="MainContent_RadioButtonList1_3">Poor</label></td>
- </tr>
- </tbody></table>
```
...
+ <table><tr><td><input id="759a6aa277b04c639c3e766e9e9a01c4_0" name="759a6aa277b04c639c3e766e9e9a01c4" type="radio" value="S" />
- <tbody><tr>
+ <label for="759a6aa277b04c639c3e766e9e9a01c4_0">Small</label></td><td><input id="759a6aa277b04c639c3e766e9e9a01c4_1" name="759a6aa277b04c639c3e766e9e9a01c4" type="radio" value="M" />
- <td><input id="RadioButtonList2_0" type="radio" value="Yes" /><label for="MainContent_RadioButtonList2_0">Yes</label></td><td><input id="RadioButtonList2_1" type="radio" value="No" /><label for="MainContent_RadioButtonList2_1">No</label></td>
+ <label for="759a6aa277b04c639c3e766e9e9a01c4_1">Medium</label></td><td><input id="759a6aa277b04c639c3e766e9e9a01c4_2" name="759a6aa277b04c639c3e766e9e9a01c4" type="radio" value="L" />
- </tr><tr>
+ <label for="759a6aa277b04c639c3e766e9e9a01c4_2">Large</label></td><td><input id="759a6aa277b04c639c3e766e9e9a01c4_3" name="759a6aa277b04c639c3e766e9e9a01c4" type="radio" value="XL" />
- <td><input id="RadioButtonList2_2" type="radio" value="Maybe" /><label for="MainContent_RadioButtonList2_2">Maybe</label></td><td></td>
...
+ <table style="border-width:0;"><tr> <td><a href=""><img alt="Collapse Home" src="_content/Fritz.BlazorWebFormsComponents/TreeView/Default_Collapse.gif" style="border-width:0;" title="Collapse Home" /></a></td><td style="white-space:nowrap;"><input type="checkbox" /><a href="/" id="SampleTreeViewt0" target="Content">Home</a></td></tr></table><div><table style="border-width:0;"><tr><td><div style="width:20px; height:1px;"></div></td><td><img alt="" src="_content/Fritz.BlazorWebFormsComponents/TreeView/Default_NoExpand.gif" /></td><td style="white-space:nowrap;"><a id="SampleTreeViewt0">Foo</a></td></tr></table>
- <tbody><tr>
+ <table style="border-width:0;"><tr><td><div style="width:20px; height:1px;"></div></td><td><a href=""><img alt="Collapse Bar" src="_content/Fritz.BlazorWebFormsComponents/TreeView/Default_Collapse.gif" style="border-width:0;" title="Collapse Bar" /></a></td><td style="white-space:nowrap;"><input type="checkbox" /><a id="SampleTreeViewt0">Bar</a></td></tr></table><div><table style="border-width:0;"><tr><td><div style="width:20px; height:1px;"></div></td><td><div style="width:20px; height:1px;"></div></td><td><a href=""><img alt="Collapse Baz" src="_content/Fritz.BlazorWebFormsComponents/TreeView/Default_Collapse.gif" style="border-width:0;" title="Collapse Baz" /></a></td><td style="white-space:nowrap;"><input type="checkbox" /><a id="SampleTreeViewt0">Baz</a></td></tr></table><div><table style="border-width:0;"><tr><td><div style="width:20px; height:1px;"></div></td><td><div style="width:20px; height:1px;"></div></td><td><div style="width:20px; height:1px;"></div></td><td><img alt="" src="_content/Fritz.BlazorWebFormsComponents/TreeView/Default_NoExpand.gif" /></td><td style="white-space:nowrap;"><a id="SampleTreeViewt0">BlazorMisterMagoo</a></td></tr></table></div></div></div>
- <td><a href="Home.aspx" id="SampleTreeViewn0i" tabindex="-1" target="Content"><img alt="This is the home image tooltip" src="../../Content/Images/C#.png" style="border-width:0;" title="This is the home image tooltip" /></a></td><td style="white-space:nowrap;"><input checked id="SampleTreeViewn0CheckBox" name="MainContent_SampleTreeViewn0CheckBox" type="checkbox" /><a class="MainContent_SampleTreeView_0" href="Home.aspx" id="SampleTreeViewn0" target="Content">Home</a></td>
+ </div>
- </tr>
- </tbody></table><div id="SampleTreeViewn0Nodes" style="display:block;">
- <table style="border-width:0;">
- <tbody><tr>
- <td><div style="width:20px; height:1px;"></div></td><td style="white-space:nowrap;"><input id="SampleTreeViewn1CheckBox" name="MainContent_SampleTreeViewn1CheckBox" title="ToolTop" type="checkbox" /><a class="MainContent_SampleTreeView_0" href="Page1.aspx" id="SampleTreeViewn1" target="Content" title="ToolTop">Page1</a></td>
- </tr>
- </tbody></table><div id="SampleTreeViewn1Nodes" style="display:none;">
- <table style="border-width:0;">
- <tbody><tr>
- <td><div style="width:20px; height:1px;"></div></td><td><div style="width:20px; height:1px;"></div></td><td style="white-space:nowrap;"><input id="SampleTreeViewn2CheckBox" name="MainContent_SampleTreeViewn2CheckBox" type="checkbox" /><a class="MainContent_SampleTreeView_0" href="Section1.aspx" id="SampleTreeViewn2" target="Content">Section 1</a></td>
- </tr>
- </tbody></table>
- </div><table style="border-width:0;">
- <tbody><tr>
- <td><div style="width:20px; height:1px;"></div></td><td style="white-space:nowrap;"><input id="SampleTreeViewn3CheckBox" name="MainContent_SampleTreeViewn3CheckBox" type="checkbox" /><a class="MainContent_SampleTreeView_0" href="Page2.aspx" id="SampleTreeViewn3" target="Content">Page 2</a></td>
- </tr>
- </tbody></table>
- </div>
