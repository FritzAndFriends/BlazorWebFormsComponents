...
- Writing and tuning Copilot skills (`.squad/skills/` and `migration-toolkit/skills/`)
...
After making a decision others should know, write it to `.squad/decisions/inbox/psylocke-{brief-slug}.md` — the Scribe will merge it.
