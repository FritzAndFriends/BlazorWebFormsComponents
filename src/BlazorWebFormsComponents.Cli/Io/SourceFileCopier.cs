...
public class SourceFileCopier
{
    ...
    public SourceFileCopier(OutputWriter outputWriter, IEnumerable<ICodeBehindTransform> transforms)
    {
        ...
        _transforms = transforms
            .Where(t => t.Name is "UsingStrip" or "IdentityUsing" or "HttpUtilityRewrite" or "EntityFramework" or "EfContextConstructor" or "DbContextInstantiation" or "HttpContextAccessor" or "SelectMethodMaterialize" or "LegacyHelperStub" or "TypeMismatchFix" or "EagerLoadNavigation")
            .OrderBy(t => t.Order)
            .ToList();
    }
