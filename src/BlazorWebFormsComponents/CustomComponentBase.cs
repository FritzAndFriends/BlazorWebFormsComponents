...
namespace BlazorWebFormsComponents
{
	...
	/// </summary>
	public abstract class CustomComponentBase : IComponent, IHandleEvent, IHandleAfterRender
	{
		internal RenderFragment _renderFragment;
		private RenderHandle _renderHandle;
		private bool _initialized;
		internal bool _hasNeverRendered = true;
		internal bool _hasPendingQueuedRender;
