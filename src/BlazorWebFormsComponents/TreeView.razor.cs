...
namespace BlazorWebFormsComponents
{
	public partial class TreeView : BaseDataBoundComponent, ITreeViewStyleContainer
	{
		...
		#region Image / tooltip properties

		/// <summary>
		/// Gets or sets the tooltip for the collapse image.
		/// </summary>
		[Parameter]
		public string CollapseImageToolTip { get; set; }

		/// <summary>
		/// Gets or sets the URL for the image displayed next to a collapsible node.
		/// </summary>
		[Parameter]
		public string CollapseImageUrl { get; set; }

		/// <summary>
		/// Gets or sets the tooltip for the expand image.
		/// </summary>
		[Parameter]
		public string ExpandImageToolTip { get; set; }

		/// <summary>
		/// Gets or sets the URL for the image displayed next to an expandable node.
		/// </summary>
		[Parameter]
		public string ExpandImageUrl { get; set; }

		/// <summary>
		/// Gets or sets the URL for the image displayed next to a non-expandable node.
		/// </summary>
		[Parameter]
		public string NoExpandImageUrl { get; set; }

		/// <summary>
		/// Gets or sets the path to the folder containing line images for the tree.
		/// </summary>
		[Parameter]
		...
		#region Data-binding configuration

		/// <summary>
		/// Gets or sets whether tree node bindings are automatically generated. Migration stub.
		/// </summary>
		[Parameter]
		public bool AutoGenerateDataBindings { get; set; }

		/// <summary>
		/// Gets or sets the maximum depth at which data binding occurs. -1 means unlimited.
		/// </summary>
		[Parameter]
		public int MaxDataBindDepth { get; set; } = -1;

		/// <summary>
		/// Gets or sets whether client-side expand/collapse script is enabled. Migration stub.
		/// </summary>
		[Parameter]
